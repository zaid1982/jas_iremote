...
<script type="text/javascript">  
    ...
    $(document).ready(function () {
        ...
        chart_hm4_1('hm4_chart_1');
        chart_hm4_2('hm4_chart_2');
                    ...
                    {mData: 'data7', sClass: 'text-center',
                        mRender: function (data, type, row) {
                            if (row.data7 == '23/10/2016')
                                ...
                                $label = '<a href="javascript:void(0);" tabindex="0" class="badge bg-color-red" data-toggle="popover" data-trigger="click" data-placement="left" data-original-title="<i class=\'fa fa-fw fa-warning\'></i> <b>Reason of Lateness</b>" data-content="<form action=\'#\' ><div class=\'row\'><div class=\'col-md-11\'><textarea rows=\'4\' class=\'form-control\'></textarea></div></div></br><div class=\'form-actions\'><div class=\'row\'><div class=\'col-md-12\'><button class=\'btn btn-primary btn-sm\' type=\'button\' onclick=\'test();\'>Submit</button></div></div></div></form>" data-html="true">' + row.data7 + '</a>';
                            else 
                                $label = row.data7;
                            return $label;
                        }
    ...
    function chart_hm4_1(chart_div) {
        Highcharts.chart(chart_div, {
            ...
            series: [{
                ...
                data: [
                    ...
                    {name:'Add Analyzer', y:4, short:'Add Analyzer'},
    ...
    function chart_hm4_2(chart_div,parameter,dataset) {
        var categories = ['Complaint Feedback',
            'CEMS Additional Analyzer', 'PEMS Consultant Registration', 'CEMS Consultant Registration', 'PEMS Installation', 'CEMS Installation'];
        Highcharts.chart(chart_div, {
            chart: {
                type: 'bar',
                options3d: {
