...
<script type="text/javascript">  
    ...
    $(document).ready(function () {
        ...
        chart_hm2_1('hm2_chart_1');
        chart_hm2_2('hm2_chart_2');
        chart_hm2_3('hm2_chart_3');
    
    });
    
    function chart_hm2_1(chart_div,parameter,dataset) {
    ...
    function chart_hm2_2(chart_div,parameter,dataset) {
    ...
    function chart_hm2_3(chart_div,parameter,dataset) {
