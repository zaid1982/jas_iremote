...
<script type="text/javascript">  
                ...
                [
                    ...
                    {mData: null, bSortable: false, sClass: 'text-center',
                        mRender: function (data, type, row) {
                            ...
                            $label = '<button type="button" class="btn btn-info btn-xs" id="itp_btn_info" title="Application Information" onclick="f_load_'+modal_open+' (4, \'\', '+row.wfTask_refValue+',\'itp\');"><i class="fa fa-info-circle"></i></button>';
                            $label += ' <button type="button" class="btn btn-success btn-xs" id="itp_btn_edit" title="Process Application" onclick="f_load_action (2, '+row.wfTask_id+',\'itp\');"><i class="fa fa-mail-forward"></i></button>';
                            return $label;
                        }
                    }
                ]
    ...
    function f_table_itp2_title () {
        ...
        if ($('#itp2_dateSubmit').val() != '') {
            txt_title = 'Received Date : '+$('#itp2_dateSubmit').val();
            if ($('#itp2_dateDue').val() != '') 
