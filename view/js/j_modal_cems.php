<script type="text/javascript">
    ...
    let data_mce_document;
    let mce_otable_consultant;
    let data_mce_consultant;
    let mce_otable_docNormalize;
    let data_mce_docNormalize;
    let mce_otable_personnel;
    let data_mce_personnel;
    let mce_interval;
    ...
    $(document).ready(function () {
        ...
        $('#mce_btn_next').on('click', function () {
            const stepNum = $('#mce_wizard').wizard('selectedItem');
            if (stepNum.step === 4)
                    ...
                    validators: {
                        callback: {
                            ...
                            callback: function (value) {
                                const check = $('#form_mce_2_1').find('[name="mce_indReason_id[]"][value=4]').is(':checked');
        ...
        let datatable_mce_written = undefined;
        mce_otable_written = $('#datatable_mce_written').DataTable({
            ...
            "rowCallback": function (nRow, aData, index) {
                ...
                const info = mce_otable_written.page.info();
                $('td', nRow).eq(0).html(info.page * info.length + (index + 1));
            },
            "drawCallback": function () {
        ...
        $('#mce_btn_add_written').on('click', function () {
            let bootstrapValidator = $("#form_mce_2_2").data('bootstrapValidator');
            bootstrapValidator.validate();
            if (bootstrapValidator.isValid()) {       
                $('#modal_waiting').on('shown.bs.modal', function(e){
                    let formData = new FormData($('#form_mce_2_2')[0]);
        ...
        let datatable_mce_document = undefined;
        mce_otable_document = $('#datatable_mce_document').DataTable({
            ...
            "rowCallback": function (nRow, aData, index) {
                ...
                const info = mce_otable_document.page.info();
                $('td', nRow).eq(0).html(info.page * info.length + (index + 1));
            },
            "drawCallback": function () {
        ...
        $('#mce_btn_add_document').on('click', function () {
            let bootstrapValidator = $("#form_mce_2_3").data('bootstrapValidator');
            bootstrapValidator.validate();
            if (bootstrapValidator.isValid()) {       
                $('#modal_waiting').on('shown.bs.modal', function(e){
                    let formData = new FormData($('#form_mce_2_3')[0]);
        ...
        let datatable_mce_consultant = undefined;
        mce_otable_consultant = $('#datatable_mce_consultant').DataTable({
            ...
            "rowCallback": function (nRow, aData, index) {
                ...
                const info = mce_otable_consultant.page.info();
                $('td', nRow).eq(0).html(info.page * info.length + (index + 1));
            },
            "drawCallback": function () {
        ...
        $('#mce_btn_add_consultant').on('click', function () {
            let bootstrapValidator = $("#form_mce_3_3").data('bootstrapValidator');
            bootstrapValidator.validate();
            if (bootstrapValidator.isValid()) { 
        ...
        let datatable_mce_docNormalize = undefined;
        mce_otable_docNormalize = $('#datatable_mce_docNormalize').DataTable({
            ...
            "rowCallback": function (nRow, aData, index) {
                ...
                const info = mce_otable_docNormalize.page.info();
                $('td', nRow).eq(0).html(info.page * info.length + (index + 1));
            },
            "drawCallback": function () {
        ...
        $('#mce_btn_add_docNormalize').on('click', function () {
            let bootstrapValidator = $("#form_mce_3_2").data('bootstrapValidator');
            bootstrapValidator.validate();
            if (bootstrapValidator.isValid()) {       
                $('#modal_waiting').on('shown.bs.modal', function(e){
                    let formData = new FormData($('#form_mce_3_2')[0]);
        ...
        $('#mce_btn_add_personnel').on('click', function () {
            let bootstrapValidator = $("#form_mce_4").data('bootstrapValidator');
            bootstrapValidator.validate();
            if (bootstrapValidator.isValid()) { 
        ...
        let datatable_mce_personnel = undefined;
        mce_otable_personnel = $('#datatable_mce_personnel').DataTable({
            ...
            "rowCallback": function (nRow, aData, index) {
                ...
                const info = mce_otable_personnel.page.info();
                $('td', nRow).eq(0).html(info.page * info.length + (index + 1));
            },
            "drawCallback": function () {
            ...
            "aoColumns":
                [
                    ...
                    {mData: null, sClass: 'text-center',
                        mRender: function (data, type, row) {
                            return '<button type="button" class="btn btn-danger btn-xs mce_hideView" title="Delete" onclick="f_mce_delete_personnel ('+row.indPers_id+');"><i class="fa fa-trash-o"></i></button>';
                        }
                    }
                ]
        });
                ...
                mce_snote_wfTask_remark : {
                    validators: {
                        callback: {
                            ...
                            callback: function() {
                                const code = $('[name="mce_snote_wfTask_remark"]').summernote('code');
...
//            mce_interval = 0;
            $.each(data_mce_parameter, function(u){
                const bootstrapValidator = $("#form_mce_2_1").data('bootstrapValidator');
        ...
        $('#mce_btn_submit').on('click', function () {
            ...
            bootstrapValidator = $("#form_mce_3_1").data('bootstrapValidator');
            bootstrapValidator.validate();
            if (!bootstrapValidator.isValid()) {         
...
//            }
            ...
            bootstrapValidator = $("#form_mce_5").data('bootstrapValidator');
            bootstrapValidator.validate();
            if (!bootstrapValidator.isValid()) {         
            ...
            if (f_submit_forms('form_mce,#form_mce_2_1,#form_mce_3_1,#form_mce_5', 'p_registration')) {
                $.SmartMessageBox({
                    ...
                    if (ButtonPressed === "Yes") {            
                        $('#modal_waiting').on('shown.bs.modal', function(e){    
                            const submit_status = $('#mce_wfTask_status').val() === '2' ? '10' : '13';
                            const submit_msg = $('#mce_wfTask_status').val() === '2' ? 'Your application successfully submitted. Result will be alerted through your email.' : 'Your application successfully resubmitted. Result will be alerted through your email.';
    ...
    function f_mce_set_link_consAll (consAll_id) {
        if (consAll_id === '' || consAll_id === null)
            ...
            const wfTrans_id = f_get_value_from_table('t_consultant_cems', 'consAll_id', consAll_id, 'wfTrans_id');
    ...
    function f_mce_set_yearRATA() {
        const searchIDs = $("input[name='mce_q_indQuarter_no[]']:checked").map(function(){
            return $(this).val();
        }).get();
    ...
    function f_load_cems (load_type, wfGroup_id, indAll_id, otable) {
        $('#modal_waiting').on('shown.bs.modal', function(e){
            ...
            $("input[name='mce_indAll_installType'][value=" + installation_all.indAll_installType + "]").prop('checked', true);
            ...
            if (installation_all.indAll_qaFreqYearly === '1')
                $('.mce_q_year').show();
            const industrial_quarter = f_get_general_info_multiple('t_industrial_quarter', {indAll_id:$('#mce_indAll_id').val()});
            ...
            const industrial_pollution = f_get_general_info_multiple('t_industrial_pollution', {indAll_id:$('#mce_indAll_id').val()});
            ...
            const industrial_reason = f_get_general_info_multiple('t_industrial_reason', {indAll_id:$('#mce_indAll_id').val()});
            ...
            if (mce_load_type >= 3) {
                ...
                if (mce_load_type >= 4) {
                    ...
                    const checklist_task = f_get_general_info_multiple('t_checklist_task', {wfTask_id:$('#mce_wfTask_id').val(), checklistTask_status:'1'});
