                ...
                <div class="well well-light">
                    ...
                    <form class="form-horizontal" id="form_mqj_form_2" method="post" enctype="multipart/form-data">
                        <div class="col-md-12 form-group">
                            <label><span class="badge badge-success pull-left"><b>GAS </b> </span>&nbsp; Attachment</label>
                        </div><br/>
                        <div class="row form-group" id="mqa_doc_one">
                            <div class="form-group">
                                <label class="col-md-2 control-label" style="margin-top: -10px !important;">Callibration Drift Test Report:</label> 
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="file" class="form-control" id="mqj_doc_cdt" name="mqj_doc_cdt" style="width: 100%">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default" type="button" id="mqj_btn_add_doc_cdt"><i class="fa fa-upload"></i></button>
                                        </span>
                                    </div> 
                                </div> 
                                <div class="col-md-4">
                        ...
                        <div class="form-group mqj_doc_rata">
                            <label class="col-md-2 control-label" style="margin-top: -10px !important;">Relative Accuracy Test Audit Report: </label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <input type="file" class="form-control" id="mqj_doc_rata" name="mqj_doc_rata" style="width: 100%">
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" id="mqj_btn_add_doc_rata"><i class="fa fa-upload"></i></button>
                                    </span>
                                </div> 
                            </div> 
                            <div class="col-md-4">
                    ...
                    <div class="well well-light">
                        <div class="row mqa_doc_two form-group">
                            ...
                            <div class="form-group mqa_doc_two">
                                <label class="col-md-2 control-label">Response Colleration Audit (RCA) Report: </label>
                                <div class="col-md-4 mqa_doc_two">
                                    <div class="input-group mqa_doc_two">
                                        <input type="file" class="form-control" id="mqj_doc_rca" name="mqj_doc_rca" style="width: 100%">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default" type="button" id="mqj_btn_add_doc_rca"><i class="fa fa-upload"></i></button>
                                        </span>
                                    </div>   
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="row form-group" id="mqa_doc_three">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="file" class="form-control" id="mqj_doc_fapt" name="mqj_doc_fapt" style="width: 100%">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default" type="button" id="mqj_btn_add_doc_fapt"><i class="fa fa-upload"></i></button>
                                        </span>
                                    </div> 
                                </div>
                                <div class="col-md-4">
