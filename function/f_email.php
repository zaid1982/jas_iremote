...
//                }
    ...
    public function send_email_initialRATA($pic, $name, $app_type, $trans_no, $company_name, $reg_no) {
        try {     
            ...
            $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n"; 
            $to = $pic; 
            $subject = "JAS iRemote System - ".$app_type." Application Initial Quality Assurance date.";
            $message = "<html><body>";
            $message .= "<p>Dear ".$name.",</p>";
            $message .= "<p>The initial Quality Assurance date for the ".$app_type.", application no. ".$trans_no." has been set.</p>";
            $message .= "<p>Application No. : <strong>".$trans_no."</strong><br>";
            $message .= "Premise Name : <strong>".$company_name."</strong><br>";
            $message .= "JAS File No. : <strong>".$reg_no."</strong><br>";
            $message .= "Status : <strong>Initial Quality Assurance</strong><br>";
            $message .= "<p>Please perform the initial Quality Assurance and submit the report through system.</p>";
            $message .= "<p><a href=\"http://iremote.doe.gov.my\">http://iremote.doe.gov.my</a></p>";
            $message .= "<br><br><br>";
            $message .= "<i>Note: This is and automail from iRemote System. Please do not reply to the email.</i>";
            $message .= "</html></body>";
    ...
    public function send_email_verify_initRATA($pic, $company_name, $app_type) {
        try {     
            ...
            $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n"; 
            $to = $pic; 
            $subject = "JAS iRemote System - ".$app_type." Application - Initial Quality Assurance report to be verified.";
            $message = "<html><body>";
            $message .= "<p>Dear <i>Pegawai Penyelia</i>,</p>";
            $message .= "<p>Please be informed that you have a new incoming ".$app_type." Application - Initial Quality Assurance report to be verified from <strong>".$company_name."</strong>.</p>";
            $message .= "<p>Kindly login to iRemote System to verify the application.</p>";
            $message .= "<p><a href=\"http://iremote.doe.gov.my\">http://iremote.doe.gov.my</a></p>";
            $message .= "<br><br><br>";
            $message .= "<i>Note: This is and automail from iRemote System. Please do not reply to the email.</i>";
    ...
    public function send_email_return_initialRATA($pic, $name, $app_type, $trans_no, $company_name, $reg_no) {
        try {     
            ...
            $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n"; 
            $to = $pic; 
            $subject = "JAS iRemote System - ".$app_type." Application Initial Quality Assurance returned to be revised.";
            $message = "<html><body>";
            $message .= "<p>Dear ".$name.",</p>";
            $message .= "<p>The initial Quality Assurance for the ".$app_type.", application no. ".$trans_no." has been returned for your revision.</p>";
            $message .= "<p>Application No. : <strong>".$trans_no."</strong><br>";
            $message .= "Premise Name : <strong>".$company_name."</strong><br>";
            $message .= "JAS File No. : <strong>".$reg_no."</strong><br>";
            $message .= "Status : <strong>Initial Quality Assurance (returned)</strong><br>";
    ...
    public function send_email_redo_initialRATA($pic, $name, $app_type, $trans_no, $company_name, $reg_no) {
        try {     
            ...
            $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n"; 
            $to = $pic; 
            $subject = "JAS iRemote System - ".$app_type." Application Initial Quality Assurance fail to be redo.";
            $message = "<html><body>";
            $message .= "<p>Dear ".$name.",</p>";
            $message .= "<p>Unfortunately the result initial Quality Assurance for the ".$app_type.", application no. ".$trans_no." is fail and need to be redone.</p>";
            $message .= "<p>Application No. : <strong>".$trans_no."</strong><br>";
            $message .= "Premise Name : <strong>".$company_name."</strong><br>";
            $message .= "JAS File No. : <strong>".$reg_no."</strong><br>";
            $message .= "Status : <strong>Initial Quality Assurance (fail, need to redo)</strong><br>";
            $message .= "<p>Please redone the Initial Quality Assurance as commented by the JAS Officer in the system.</p>";
            $message .= "<p><a href=\"http://iremote.doe.gov.my\">http://iremote.doe.gov.my</a></p>";
            $message .= "<br><br><br>";
            $message .= "<i>Note: This is and automail from iRemote System. Please do not reply to the email.</i>";
            $message .= "</html></body>";
